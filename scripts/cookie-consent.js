            ...
            <div class="container mx-auto px-4">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div class="text-sm">
                        ...
                        <p class="text-gray-300">By continuing to browse, you agree to our use of cookies. <a href="/privacy-policy" class="text-blue-300 hover:text-white underline">Learn more</a></p>
                    </div>
